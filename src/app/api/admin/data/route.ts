...
export async function GET(request: Request) {
  ...
  items: items.map((i: any) => ({
    ...
    backlog: backlogRows.map((b) => ({
      ...
      prompt_model: b.prompt_model ?? null,
      prompt_created_at: b.prompt_created_at?.toISOString() ?? null,
      prompt_duration_sec: b.prompt_duration_sec ?? null,
      prompt_log_id: b.prompt_log_id ?? null,
      prompt_about: b.prompt_about ?? null,
      doc_link: b.doc_link,
